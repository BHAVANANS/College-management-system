...
<?php  
	if (isset($_POST['sub'])) {
		...
		$query="insert into courses(course_code,course_name,no_of_semesters,no_of_years)values('$course_code','$course_name','$no_of_semesters','$no_of_years')";
					...
					<div class="col-md-12">
						<form action="courses.php" method="post">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label for="exampleInputEmail1">Number of semesters:</label>
										<input type="text" name="no_of_semesters" class="form-control" required placeholder="Enter no of Semesters">
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<label for="exampleInputPassword1">No of Years:</label>
										<input type="text" name="no_of_years" class="form-control" required  placeholder="Enter No of Years">
									</div>
								</div>
							</div>
							<div class="row w-100">
					...
					<div class="col-md-12 ml-2">
						<section class="mt-3">
							<table class="w-100 table-elements mb-5 table-three-tr" cellpadding="3">
								...
								<?php
									$sr=1;
									$query="select course_code,course_name,no_of_semesters,no_of_years from courses";
									$run=mysqli_query($con,$query);
