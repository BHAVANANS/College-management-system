...
// *****************************************Images upload code starts here********************************************************** 
		...
		$aadhar_card = $_FILES['aadhar_card']['name'];$tmp_name=$_FILES['aadhar_card']['tmp_name'];$path = "images/".$aadhar_card;move_uploaded_file($tmp_name, $path);


// *****************************************Images upload code end here********************************************************** 

 		$query="Insert into student_info(roll_no,first_name,middle_name,last_name,father_name,email,mobile_no,course_code,profile_image,prospectus_issued,prospectus_amount,applicant_status,application_status,dob,gender,permanent_address,current_address,place_of_birth,matric_complition_date,matric_certificate,fa_complition_date,fa_certificate,aadhar_number,aadhar_card)values('$roll_no','$first_name','$middle_name','$last_name','$father_name','$email','$mobile_no','$course_code','$profile_image','$prospectus_issued','$prospectus_amount','$applicant_status','$application_status','$dob','$gender','$permanent_address','$current_address','$place_of_birth','$matric_complition_date','$matric_certificate','$fa_complition_date','$fa_certificate','$aadhar_number','$aadhar_card')";
							        ...
							        <form action="student.php" method="POST" enctype="multipart/form-data">
										...
										<div class="row">
								  		...
								  		<div class="row">
											<div class="col-md-4">
											    <div class="form-group">
											        <label for="exampleInputEmail1">Admission quota: *</label>
											        <select class="browser-default custom-select" name="prospectus_issued" required>
											...
											<div class="col-md-4">
												<div class="form-group">
												    <label for="exampleInputPassword1">Admission Amount paid: *</label>
												    <select class="browser-default custom-select" name="prospectus_amount" required>
													  <option>Select Option</option>
								  		...
								  		<div class="row">
											<div class="col-md-4">
											    <div class="form-group">
											        ...
											        <select class="browser-default custom-select" name="applicant_status" required>
													  <option>Select Option</option>
											...
											<div class="col-md-4">
												<div class="form-group">
												    ...
												    <select class="browser-default custom-select" name="application_status" required>
													  <option>Select Option</option>
								  		...
								  		<div class="row">
											<div class="col-md-4">
											    <div class="form-group">
											        <label for="exampleInputEmail1">Matric/10th pass year: *</label>
								  		...
								  		<div class="row">
											<div class="col-md-4">
											    <div class="form-group">
											        <label for="exampleInputEmail1">PUC/12th/Diploma pass year: *</label>
										...
										<div class="row">
											<div class="col-md-4">
											    <div class="form-group">
											        ...
											        <input type="number" name="aadhar_number" class="form-control" required>
											    </div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
												    <label for="exampleInputPassword1">Upload aadhaar: *</label>
