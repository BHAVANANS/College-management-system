...
<?php  
	if (isset($_POST['sub'])) {
		...
		$query="insert into course_subjects(subject_code,subject_name,course_code,semester,credit_points)values('$subject_code','$subject_name','$course_code','$semester','$credit_points')";
					...
					<div class="col-md-12">
						<form action="subjects.php" method="post">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label for="exampleInputPassword1">Credit Points:</label>
										<input type="number" name="credit_points" class="form-control"  placeholder="Enter Subject Credit Pointss" required>
									</div>
								</div>
					...
					<div class="col-md-12 ml-2">
						<section class="mt-3">
							<table class="w-100 table-elements table-three-tr" cellpadding="3">
								...
								<?php
									$sr=1;
									$query="select subject_code,subject_name,course_code,semester,credit_points from course_subjects";
									$run=mysqli_query($con,$query);
									while($row=mysqli_fetch_array($run)) {
									echo	"<tr>";
									echo	"<td>".$sr++."</td>";
