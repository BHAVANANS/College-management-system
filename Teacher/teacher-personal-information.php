...
<?php 
	...
	if (isset($_POST['sub'])) {
		...
		$query="update teacher_info set first_name='$first_name',middle_name='$middle_name',last_name='$last_name',father_name='$father_name',phone_no='$phone_no',gender='$gender',designation='$designation',specification_area='$specification_area' where teacher_id='$teacher_id'";
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="designation"  placeholder="Designation" value=<?php echo $row['designation'] ?>>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label for="exampleInputEmail1">Area of specification: *</label>
										<input type="text" class="form-control" name="specification_area" placeholder="Specification area " value=<?php echo $row['specification_area'] ?>>
									</div>
								</div>
							</div>
						<?php } ?>
